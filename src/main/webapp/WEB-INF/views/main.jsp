								...
								<div class="image">
									<h3>
										<a href="#" class="tag category">Real Estate</a> <a
											href="itemDetail" class="title">자바의 정석</a>
										<!--  <span onclick="location.href='single-listing-1.html'" class="tag">책</span> -->
									</h3>
									<a href="itemDetail" class="image-wrapper background-image">
							...
							<div class="wrapper">
								<div class="image">
									<h3>
										...
										<a href="single-listing-1.html" class="title">자바의 정석</a> <span
											href="#" class="tag ">책</span>
									</h3>

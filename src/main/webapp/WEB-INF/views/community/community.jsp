					...
					<div class="row flex-column-reverse flex-md-row">
						<div class="col-md-9">
							...
							<div class="section-title clearfix">
								...
								<div
									class="float-right float-xs-none d-xs-none thumbnail-toggle">
							...
							<div
								...
								<div class="item">
									<div class="wrapper"
										onclick="location.href='community-detail.html'">
										<h3>
										...
										<div class="description" style="height: 9rem;">
											<p style="width: 100%;">
												<i class="fa fa-question"></i> Lorem ipsum dolor sit amet,
												consectetur adipiscing elit. Nullam venenatis lobortis Lorem
												ipsum dolor sit amet, consectetur adipiscing elit. Nullam
												venenatis lobortis Lorem ipsum dolor sit amet, consectetur
												adipiscing elit. Nullam venenatis lobortis Lorem ipsum dolor
												sit amet, consectetur adipiscing elit. Nullam venenatis
												lobortis Lorem ipsum dolor sit amet, consectetur adipiscing
												elit. Nullam venenatis lobortis Lorem ipsum dolor sit amet,
												consectetur adipiscing elit. Nullam venenatis lobortis
											</p>
										</div>
										<!--end description-->
										...
										<div class="alternative-search-form">
											...
											<div class="collapse" id="collapseAlternativeSearchForm">
												<div class="wrapper">
													...
													<div class="form-group">
														<h4>Price Range</h4>
														<div class="ui-slider" id="price-slider"
															data-value-min="10" data-value-max="400"
